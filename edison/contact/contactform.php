...
$formproc->AddRecipient('medusadesigncosales@gmail.com'); //<<---Put your email address here
...
<form id='contactus' action='<?php echo $formproc->GetSelfScript(); ?>' method='post' enctype="multipart/form-data" accept-charset='UTF-8'>
    ...
    <fieldset >
        ...
        <div class='container text-center style'>
            <p style="text-align:center; width: 60%; margin: 0 auto;">


                We offer a wide range of website elements that can be hand tailored to your specific design. Please let us know which elements you would like to incorporate. <br><br><b>YES</b> or <b>NO</b>
        ...
        <div class='container'>
            <label for='message' >Additional information you would like to share with Medusa Design Co to aid in the content or design of your website:</label><br>
            <span id='contactus_message_errorloc' class='error'></span>
        ...
        <h4>*** Please use the upload buttons on this form if you only have one or two images to share with us. <br> If you intend on using more than two images and text documents on your website please use the DropBox link below.</h4>

...
<div id="home">
    ...
    <div id="menu">
        <img class="center-block img-responsive" src="../previews/images/legal_six.jpg" alt="Check out the live preview!">

        <br><h1><a class="btn btn-lg btn-info center-block" href="../live/legal/template_six/index.html">Live Example</a></h1>

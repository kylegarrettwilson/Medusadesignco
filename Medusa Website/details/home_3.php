...
<div id="home">
    ...
    <div id="menu">
        <img class="center-block img-responsive" src="../previews/images/home_three.jpg" alt="Check out the live preview!">

        <br><h1><a class="btn btn-lg btn-info center-block" href="../live/home_care/template_three/index.php">Live Example</a></h1>

...
<div id="home">
    ...
    <div id="menu">
        <img class="center-block" src="../previews/images/home_five.jpg" alt="Check out the live preview!">

        <br><h1><a class="btn btn-lg btn-info center-block" href="../live/home_care/template_five/index.php">Live Preview</a></h1>

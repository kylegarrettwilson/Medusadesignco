...
<div id="home">
    ...
    <div id="menu">
        <img class="center-block" src="../previews/images/health_four.jpg" alt="Check out the live preview!">

        <br><h1><a class="btn btn-lg btn-info center-block" href="../live/health_care/template_four/index.php">Live Preview</a></h1>

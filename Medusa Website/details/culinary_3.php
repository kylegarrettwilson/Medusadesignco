...
<div id="home">
    ...
    <div id="menu">
        <img class="center-block" src="../previews/images/cul_three.jpg" alt="Check out the live preview!">

        <br><h1><a class="btn btn-lg btn-info center-block" href="../live/culinary/template_three/index.html">Live Preview</a></h1>

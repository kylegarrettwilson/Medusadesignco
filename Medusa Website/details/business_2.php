...
<div id="home">
    ...
    <div id="menu">
        <img class="center-block img-responsive" src="../previews/images/business_two.jpg" alt="Check out the live preview!">

        <br><h1><a class="btn btn-lg btn-info center-block" href="../live/business/template_two/index.php">Live Example</a></h1>

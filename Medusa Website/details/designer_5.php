...
<div id="home">
    ...
    <div id="menu">
        <img class="center-block" src="../previews/images/design_five.jpg" alt="Check out the live preview!">

        <br><h1><a class="btn btn-lg btn-info center-block" href="../live/designer/template_five/index.html">Live Preview</a></h1>

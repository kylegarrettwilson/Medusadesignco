...
<!-- header -->
      ...
      <h1 class="logo"><a href="#home" class="scroll">We(b)Design</a></h1>
      <div class="menu">
        ...
        <div class="container top">
            <div class="row">
                <div class="text-center">
                    <h1>Lets Us Create Your Website</h1>
                    <p>
                        ...
                        <div class="panel-heading" role="tab">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    <i class="fa fa-file"></i> Graphic Design
                                </a>
                            </h4>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel">
                            <div class="panel-body">
                                <div class="clearfix food-list"><div class="pull-left">Service X</div><span class="pull-right"></span></div>
                                <div class="clearfix food-list"><div class="pull-left">Service X</div><span class="pull-right"></span></div>
                                <div class="clearfix food-list"><div class="pull-left">Service X</div><span class="pull-right"></span></div>
                                <div class="clearfix food-list"><div class="pull-left">Service X</div><span class="pull-right"></span></div>
                            </div>
                        ...
                        <div class="panel-heading" role="tab">
                            <h4 class="panel-title">
                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    <i class="fa fa-fire"></i> Web Design
                                </a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading" role="tab">
                            <h4 class="panel-title">
                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    <i class="fa fa-coffee"></i> Professional Online Plans
                                </a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading" role="tab">
                            <h4 class="panel-title">
                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                    <i class="fa fa-money"></i> Social Media Coaching
                                </a>
                            </h4>
                        </div>
